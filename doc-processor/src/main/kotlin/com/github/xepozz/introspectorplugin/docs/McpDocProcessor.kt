package com.github.xepozz.introspectorplugin.docs
...
class McpDocProcessorProvider : SymbolProcessorProvider {
    override fun create(environment: SymbolProcessorEnvironment): SymbolProcessor = McpDocProcessor(environment)
}
